...
const contributions = [
  ...
  },
  {
    ...
    description: 'Including a Thrust header without a CUDA compiler produced roughly 1,300 unrelated errors, none of which named the actual cause. I added a check that reports the real problem in one line and names the ways out, placed so it fires before the downstream noise begins.',
